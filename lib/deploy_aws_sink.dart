...
///
/// See the documentation in this file for [initializeApplication], [DeployAwsSink], [setupRouter] and [willOpen]
...
/// for more details.
class DeployAwsSink extends RequestSink {
  ...
  static Future initializeApplication(ApplicationConfiguration config) async {
    ...
    var configFileValues =
        new DeployAwsConfiguration(config.configurationFilePath);
  ...
  DeployAwsSink(ApplicationConfiguration options) : super(options) {
...
class DeployAwsConfiguration extends ConfigurationItem {
  DeployAwsConfiguration(String fileName) : super.fromFile(fileName);
