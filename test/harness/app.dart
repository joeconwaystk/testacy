import 'package:deploy_aws/deploy_aws.dart';
export 'package:deploy_aws/deploy_aws.dart';
export 'package:test/test.dart';

/// A testing harness for deploy_aws.
///
/// Use instances of this class to start/stop the test deploy_aws server. Use [client] to execute
...
class TestApplication {
  ...
  TestApplication() {
    configuration = new DeployAwsConfiguration("config.yaml.src");
    configuration.database.isTemporary = true;
  }

  Application<DeployAwsSink> application;
  DeployAwsSink get sink => application.mainIsolateSink;
  TestClient client;
  DeployAwsConfiguration configuration;

  /// Starts running this test harness.
  ///
  /// This method will start an [Application] with [DeployAwsSink].
  /// The declared [ManagedObject]s in this application will be
  /// used to generate a temporary database schema. The [DeployAwsSink] instance will use
  ...
  Future start() async {
    ...
    application = new Application<DeployAwsSink>();
